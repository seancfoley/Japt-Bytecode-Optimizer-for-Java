 ...
 */
public class TestUpcast3 {
	
	/**
	 * A successful field write upcast will prevent the verifier from loading SomeException
	 * @return
	 */
	void aFieldWriteMethod() {
		/* 
		 * a verifier must ensure that the type of
		 * an object written to a field matches the field type.
		 */
